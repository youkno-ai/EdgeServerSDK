...
open class EventControllerAPI {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postApiV1ActsEvents(event: Event, xEdgeAgent: String? = nil, xEdgeState: String? = nil, xEdgeClientId: String? = nil) async throws -> EdgeApiDataNewId {
     ...
     */
    open class func postApiV1ActsEventsWithRequestBuilder(event: Event, xEdgeAgent: String? = nil, xEdgeState: String? = nil, xEdgeClientId: String? = nil) -> RequestBuilder<EdgeApiDataNewId> {
        let localVariablePath = "/api/v1/acts/events"
        let localVariableURLString = BelongSDKAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: event)
