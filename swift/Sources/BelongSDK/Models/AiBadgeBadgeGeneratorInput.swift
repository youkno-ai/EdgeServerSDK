//
// AiBadgeBadgeGeneratorInput.swift
//
...
public struct AiBadgeBadgeGeneratorInput: Codable, JSONEncodable, Hashable {
    ...
    public init(description: String? = nil, reward: Reward? = nil, style: Style? = nil, palette: Palette? = nil, format: Format? = nil, animation: AiModelAnimationSpec? = nil) {
