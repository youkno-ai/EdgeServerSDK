//
// RedemptionInfoRedemptionData.swift
//
...
public struct RedemptionInfoRedemptionData: Codable, JSONEncodable, Hashable {

    public var merchantId: String?
    public var redemptionCurrencies: [String: ExchangeCurrency]?
    public var exchangedReward: Reward?
    public var redemptionReward: Reward?

    public init(merchantId: String? = nil, redemptionCurrencies: [String: ExchangeCurrency]? = nil, exchangedReward: Reward? = nil, redemptionReward: Reward? = nil) {
