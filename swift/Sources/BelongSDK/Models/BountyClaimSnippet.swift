...
public struct BountyClaimSnippet: Codable, JSONEncodable, Hashable {
    ...
    public var rejection: BountyClaimSnippetRejection?
    public var claimedAt: Int64?
    public var status: String?
    public var rejected: Bool?
    public var statusAsEnum: StatusAsEnum?

    public init(from: User? = nil, claimId: String? = nil, rejection: BountyClaimSnippetRejection? = nil, claimedAt: Int64? = nil, status: String? = nil, rejected: Bool? = nil, statusAsEnum: StatusAsEnum? = nil) {
        self.from = from
