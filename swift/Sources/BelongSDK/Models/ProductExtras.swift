...
public struct ProductExtras: Codable, JSONEncodable, Hashable {
    ...
    public var chemicalComposition: [ProductSpecificInfoChemicalInfo]?
    public var chemicalCompositions: [String: ProductSpecificInfoChemicalInfo]?
    public var certificateOfAuthenticityUrl: String?

    public init(chemicalComposition: [ProductSpecificInfoChemicalInfo]? = nil, chemicalCompositions: [String: ProductSpecificInfoChemicalInfo]? = nil, certificateOfAuthenticityUrl: String? = nil) {
