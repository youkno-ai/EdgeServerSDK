...
public struct FilterFilterDef: Codable, JSONEncodable, Hashable {
    ...
    public var options: [FilterFilterDefFilterOption]?
    public var criteriaTypeAsEnum: CriteriaTypeAsEnum?
    public var filterTypeAsEnum: FilterTypeAsEnum?

    public init(id: String? = nil, parentId: String? = nil, name: String? = nil, type: String? = nil, criteriaType: String? = nil, options: [FilterFilterDefFilterOption]? = nil, criteriaTypeAsEnum: CriteriaTypeAsEnum? = nil, filterTypeAsEnum: FilterTypeAsEnum? = nil) {
        self.id = id
...
extension FilterFilterDef: Identifiable {}
