//
// EdgeApiDataSurveyBundleResp.swift
//
...
public struct EdgeApiDataSurveyBundleResp: Codable, JSONEncodable, Hashable {
    ...
    public var surveys: [EdgeApiDataSurveyResp]?

    public init(bountyId: String? = nil, bountyType: BountyType? = nil, title: String? = nil, description: String? = nil, attachments: Attachments? = nil, surveys: [EdgeApiDataSurveyResp]? = nil) {
