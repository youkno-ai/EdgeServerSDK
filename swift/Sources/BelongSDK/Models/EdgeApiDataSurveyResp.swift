...
public struct EdgeApiDataSurveyResp: Codable, JSONEncodable, Hashable {
    ...
    public init(bountyId: String? = nil, bountyType: BountyType? = nil, survey: Survey? = nil, attachments: Attachments? = nil) {
