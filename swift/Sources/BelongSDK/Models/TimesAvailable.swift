...
public struct TimesAvailable: Codable, JSONEncodable, Hashable {
    ...
    public init(time: Int64? = nil, attribute: String? = nil, experiences: [Experience]? = nil, bookingUrl: String? = nil, creditCardRequired: Bool? = nil, availabilityType: [String]? = nil) {
        self.time = time
