...
public struct PosApiDataOrder2: Codable, JSONEncodable, Hashable {
    ...
    public var discounts: [OrderDiscountResp]?
    public var fees: [FeeResp]?
    ...
    public init(id: String? = nil, customerId: String? = nil, type: String? = nil, subtotal: Double? = nil, discount: Double? = nil, total: Double? = nil, lineItemCount: Int? = nil, isChangePaid: Bool? = nil, paidInFull: Bool? = nil, pickupCustomerArrived: Bool? = nil, pickupOrderIncoming: Bool? = nil, pickupVehicleMake: String? = nil, pickupVehicleColor: String? = nil, rn: String? = nil, onlineOrderId: String? = nil, statusId: String? = nil, status: String? = nil, items: [OrderItem]? = nil, deliveryAddress: MailingAddress? = nil, pickupDate: String? = nil, pickupTime: String? = nil, pickupPhone: String? = nil, pickupEmail: String? = nil, complete: Bool? = nil, voided: Bool? = nil, canceled: Bool? = nil, voidReason: String? = nil, createdByUser: String? = nil, createdAt: Int64? = nil, paidAt: Int64? = nil, deliveryFee: Double? = nil, discounts: [OrderDiscountResp]? = nil, fees: [FeeResp]? = nil, locationId: String? = nil, location: String? = nil, loyalty: Double? = nil, firstName: String? = nil, lastName: String? = nil, timezone: String? = nil, useType: String? = nil, verified: Bool? = nil) {
        self.id = id
...
extension PosApiDataOrder2: Identifiable {}
