...
public struct BountyDistribution: Codable, JSONEncodable, Hashable {

    public var areasList: [BountyDistributionAreas]?
    ...
    public init(areasList: [BountyDistributionAreas]? = nil, empty: Bool? = nil, global: Bool? = nil, includesEmpty: Bool? = nil, excludesEmpty: Bool? = nil, targetArea: String? = nil, excludeArea: String? = nil) {
