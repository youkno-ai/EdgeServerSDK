...
public struct BountyDistribution: Codable, JSONEncodable, Hashable {
    ...
    public init(areasList: [BountyDistributionAreas]? = nil, empty: Bool? = nil, includesEmpty: Bool? = nil, excludesEmpty: Bool? = nil, targetArea: String? = nil, excludeArea: String? = nil, global: Bool? = nil) {
