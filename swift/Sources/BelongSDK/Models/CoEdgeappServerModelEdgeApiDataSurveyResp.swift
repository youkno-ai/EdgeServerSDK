//
// CoEdgeappServerModelEdgeApiDataSurveyResp.swift
//
...
public struct CoEdgeappServerModelEdgeApiDataSurveyResp: Codable, JSONEncodable, Hashable {
    ...
    public var survey: CoEdgeappServerModelSurvey?
    public var attachments: CoEdgeappServerModelAttachments?

    public init(bountyId: String? = nil, bountyType: BountyType? = nil, survey: CoEdgeappServerModelSurvey? = nil, attachments: CoEdgeappServerModelAttachments? = nil) {
