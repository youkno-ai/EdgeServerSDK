...
public struct EdgeApiDataSurveyAnswer: Codable, JSONEncodable, Hashable {
    ...
    public var answers: BountyResponseSurveyAnswers?
    public var responseId: String?
    public var responseState: ResponseState?
    public var reward: Reward?

    public init(bountyId: String? = nil, answers: BountyResponseSurveyAnswers? = nil, responseId: String? = nil, responseState: ResponseState? = nil, reward: Reward? = nil) {
