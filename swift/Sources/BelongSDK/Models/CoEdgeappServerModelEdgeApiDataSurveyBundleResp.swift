//
// CoEdgeappServerModelEdgeApiDataSurveyBundleResp.swift
//
...
public struct CoEdgeappServerModelEdgeApiDataSurveyBundleResp: Codable, JSONEncodable, Hashable {
    ...
    public var surveys: [CoEdgeappServerModelEdgeApiDataSurveyResp]?

    public init(bountyId: String? = nil, bountyType: BountyType? = nil, title: String? = nil, description: String? = nil, attachments: CoEdgeappServerModelAttachments? = nil, surveys: [CoEdgeappServerModelEdgeApiDataSurveyResp]? = nil) {
