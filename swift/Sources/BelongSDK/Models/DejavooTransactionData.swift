...
public struct DejavooTransactionData: Codable, JSONEncodable, Hashable {
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case lTaxAmount = "LTaxAmount"
        case sTaxAmount = "STaxAmount"
