//
// CoEdgeappServerAiBountyDemoFeedGeneratorInput.swift
//
...
public struct CoEdgeappServerAiBountyDemoFeedGeneratorInput: Codable, JSONEncodable, Hashable {

    public enum PreferredTypes: String, Codable, CaseIterable {
        case _none = "NONE"
    ...
    public var preferredTypes: [PreferredTypes]?
    public var includeAttachments: Bool?
    public var deterministic: Bool?
    public var seed: Int64?

    public init(itemCount: Int? = nil, description: String? = nil, language: String? = nil, preferredTypes: [PreferredTypes]? = nil, includeAttachments: Bool? = nil, deterministic: Bool? = nil, seed: Int64? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(preferredTypes, forKey: .preferredTypes)
