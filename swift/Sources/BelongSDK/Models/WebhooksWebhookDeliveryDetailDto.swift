//
// WebhooksWebhookDeliveryDetailDto.swift
//
...
public struct WebhooksWebhookDeliveryDetailDto: Codable, JSONEncodable, Hashable {
    ...
    public init(deliveryId: UUID? = nil, status: Status? = nil, deliveryOutcome: DeliveryOutcome? = nil, attemptCount: Int? = nil, responseStatusCode: Int? = nil, responseBody: String? = nil, errorMessage: String? = nil, createdAt: Date? = nil, updatedAt: Date? = nil, lastAttemptAt: Date? = nil, nextAttemptAt: Date? = nil, endpointId: UUID? = nil, endpointDescription: String? = nil, targetUrl: String? = nil, endpointEnabled: Bool? = nil, eventLogId: UUID? = nil, publicEventId: String? = nil, eventType: String? = nil, eventCreatedAt: Date? = nil, tenantId: String? = nil, eventData: [String: AnyCodable]? = nil, deadReason: String? = nil, deadAt: Date? = nil) {
