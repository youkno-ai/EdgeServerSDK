...
public struct SurveyResult: Codable, JSONEncodable, Hashable {
    ...
    public init(answers: [String: SurveySurveyAnswer]? = nil, fundingResult: FundingResult? = nil, totalCount: Int? = nil, totalWeight: Int? = nil, averageScore: Double? = nil, leadingSurveyAnswer: SurveySurveyAnswer? = nil) {
