//
// BaseSettingsShopSettings.swift
//
...
public struct BaseSettingsShopSettings: Codable, JSONEncodable, Hashable {
    ...
    public var backgrounds: [String: BaseSettingsShopSettingsBackground]?
    ...
    public var deliveryMethodInfos: [String: BaseSettingsShopSettingsDeliveryMethodInfo]?
    public var vendorPolicies: [String: BaseSettingsPolicy]?
    ...
    public var shopOperation: BaseSettingsShopSettingsShopOperation?
    public var logins: String?
    public var kioskAddToQueue: Bool?
    public var checkoutFields: [String: String]?
    public var kioskSettings: [String: BaseSettingsShopSettingsKioskSettings]?
    public var viewConfigs: [String: BaseSettingsShopSettingsViewConfig]?
    public var sortConfigs: [String: BaseSettingsShopSettingsSortConfig]?
    public var deliveryConfigs: [String: BaseSettingsShopSettingsDeliveryConfig]?
    public var addressAutocomplete: String?
    public var tribalIdMode: String?
    public var chemicalInfoDisplayConfig: BaseSettingsShopSettingsChemicalInfoDisplayConfig?
    public var categoryConfigs: [String: BaseSettingsShopSettingsCategoryConfig]?
    public var shopChatSupportState: ShopChatSupportState?
    public var seo: [String: BaseSettingsSeoData]?
    public var stockMessageConfig: BaseSettingsShopSettingsStockMessageConfig?
    public var bannerStatuses: [String: String]?
    public var productRecommendationsStatus: String?
    public var footerConfig: BaseSettingsShopSettingsFooterConfig?
    public var syncProductConfig: BaseSettingsShopSettingsSyncProductConfig?
    public var deliveryMethods: String?
    public var alleavesEnv: String?
    public var pointOfSaleCredentials: ThirdpartiesPosPointOfSaleCredentials?
    public var posType: PosType?
    public var effectiveShopOperation: BaseSettingsShopSettingsShopOperation?
    public var analyticsInfo: BaseSettingsShopSettingsAnalytics?
    ...
    public var effectiveStockMessageConfig: BaseSettingsShopSettingsStockMessageConfig?
