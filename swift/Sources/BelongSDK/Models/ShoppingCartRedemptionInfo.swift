//
// ShoppingCartRedemptionInfo.swift
//
...
public struct ShoppingCartRedemptionInfo: Codable, JSONEncodable, Hashable {

    public var redemptionDataByMerchantId: [String: ShoppingCartRedemptionInfoRedemptionData]?
    public var empty: Bool?
    public var exchangedReward: Reward?
    public var redemptionCurrencies: [String]?
    public var redemptionReward: Reward?

    public init(redemptionDataByMerchantId: [String: ShoppingCartRedemptionInfoRedemptionData]? = nil, empty: Bool? = nil, exchangedReward: Reward? = nil, redemptionCurrencies: [String]? = nil, redemptionReward: Reward? = nil) {
