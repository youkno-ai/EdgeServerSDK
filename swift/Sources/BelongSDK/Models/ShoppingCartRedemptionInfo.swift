...
public struct ShoppingCartRedemptionInfo: Codable, JSONEncodable, Hashable {
    ...
    public init(redemptionDataByMerchantId: [String: ShoppingCartRedemptionInfoRedemptionData]? = nil, empty: Bool? = nil, redemptionCurrencies: [String]? = nil, redemptionReward: Reward? = nil, exchangedReward: Reward? = nil) {
