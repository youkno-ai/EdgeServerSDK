...
public struct BountyActivities: Codable, JSONEncodable, Hashable {
    ...
    public init(nextActivity: BountyActivitiesActivity? = nil, previousActivity: BountyActivitiesActivity? = nil, highlightedActivities: [String: BountyActivitiesActivity]? = nil, previousBountyId: String? = nil, nextBountyId: String? = nil) {
