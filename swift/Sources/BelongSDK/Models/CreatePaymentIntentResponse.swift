...
public struct CreatePaymentIntentResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(paymentIntentClientSecret: String? = nil, customerSessionClientSecret: String? = nil, customerId: String? = nil, publishableKey: String? = nil, liveMode: Bool? = nil, paymentIntentId: String? = nil) {
