//
// StickerCollectionGeneratorInput.swift
//
...
public struct StickerCollectionGeneratorInput: Codable, JSONEncodable, Hashable {
    ...
    public init(description: String? = nil, size: Int? = nil, collectionReward: Reward? = nil, stickerReward: Reward? = nil, style: Style? = nil, palette: Palette? = nil, format: Format? = nil, animation: AnimationSpec? = nil, imageGenProvider: String? = nil, videoGenProvider: String? = nil) {
