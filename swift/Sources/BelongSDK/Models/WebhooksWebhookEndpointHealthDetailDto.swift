//
// WebhooksWebhookEndpointHealthDetailDto.swift
//
...
public struct WebhooksWebhookEndpointHealthDetailDto: Codable, JSONEncodable, Hashable {
    ...
    public var circuitSuspendUntil: Date?
    ...
    public init(endpointId: UUID? = nil, description: String? = nil, targetUrl: String? = nil, enabled: Bool? = nil, circuitState: CircuitState? = nil, consecutiveFailureCount: Int? = nil, nextDispatchAllowedAt: Date? = nil, circuitSuspendUntil: Date? = nil, lastDeliveryAt: Date? = nil, lastSuccessAt: Date? = nil, lastFailureAt: Date? = nil, deliveriesLast24h: Int? = nil, successesLast24h: Int? = nil, failuresLast24h: Int? = nil, deadLettersLast24h: Int? = nil, currentDlqCount: Int? = nil, lastDeliveryOutcome: LastDeliveryOutcome? = nil, lastResponseStatusCode: Int? = nil) {
        ...
        self.circuitSuspendUntil = circuitSuspendUntil
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(circuitSuspendUntil, forKey: .circuitSuspendUntil)
