//
// BaseSettingsShopSettingsShopOperationShopSpecialHoursOfOperationSpecialHoursOfOperationSpecialDateRange.swift
//
...
public struct BaseSettingsShopSettingsShopOperationShopSpecialHoursOfOperationSpecialHoursOfOperationSpecialDateRange: Codable, JSONEncodable, Hashable {

    public var label: String?
    public var fromDate: String?
    public var toDate: String?
    public var hoursOfOperation: BaseSettingsShopSettingsShopOperationShopHoursOfOperationWeeklyHoursOfOperationDailyHoursOfOperation?
    ...
    public init(label: String? = nil, fromDate: String? = nil, toDate: String? = nil, hoursOfOperation: BaseSettingsShopSettingsShopOperationShopHoursOfOperationWeeklyHoursOfOperationDailyHoursOfOperation? = nil, empty: Bool? = nil, valid: Bool? = nil, emptyDateRange: Bool? = nil, singleDate: Bool? = nil, fromDateAsLocalDate: Date? = nil, toDateAsLocalDate: Date? = nil) {
        self.label = label
