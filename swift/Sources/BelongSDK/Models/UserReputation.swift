...
public struct UserReputation: Codable, JSONEncodable, Hashable {
    ...
    public init(type: ModelType? = nil, code: String? = nil, text: String? = nil, iconName: String? = nil, color: String? = nil, _none: Bool? = nil, standardType: Bool? = nil, iconic: Bool? = nil) {
        self.type = type
        self.code = code
        self.text = text
