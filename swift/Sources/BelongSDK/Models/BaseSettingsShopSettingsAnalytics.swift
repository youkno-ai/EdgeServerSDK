//
// BaseSettingsShopSettingsAnalytics.swift
//
...
public struct BaseSettingsShopSettingsAnalytics: Codable, JSONEncodable, Hashable {
    ...
    public init(accessToken: String? = nil, propertyInfo: PrivateCompanySettingsAnalyticsInfoPropertyInfo? = nil, dataStreamInfo: PrivateCompanySettingsAnalyticsInfoDataStreamInfo? = nil) {
