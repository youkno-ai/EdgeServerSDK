//
// ThirdpartiesOpentableConsumerAPIAPIAvailabilityTimesAvailable.swift
//
...
public struct ThirdpartiesOpentableConsumerAPIAPIAvailabilityTimesAvailable: Codable, JSONEncodable, Hashable {

    public var time: Int64?
    public var attribute: String?
    public var experiences: [ThirdpartiesOpentableConsumerAPIAPIAvailabilityExperience]?
    public var bookingUrl: String?
    public var creditCardRequired: Bool?
    public var availabilityType: [String]?

    public init(time: Int64? = nil, attribute: String? = nil, experiences: [ThirdpartiesOpentableConsumerAPIAPIAvailabilityExperience]? = nil, bookingUrl: String? = nil, creditCardRequired: Bool? = nil, availabilityType: [String]? = nil) {
        self.time = time
