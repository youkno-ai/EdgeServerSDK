...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelEdgeApiDataGeofencesResp (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelEdgeApiDataGeofencesResp>? = null
