...
data class CoedgeappservermodelEdgeApiDataUpdateClientLoginsRequest (

    @Json(name = "logins")
    val logins: kotlin.collections.List<CoedgeappservermodelEdgeApiDataUpdateClientLoginsRequest.Logins>? = null
