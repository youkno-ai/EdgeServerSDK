...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelGroupSearchResult (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelGroupSearchResult>? = null
