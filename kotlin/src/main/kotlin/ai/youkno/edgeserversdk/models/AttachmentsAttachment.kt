...
import ai.youkno.edgeserversdk.models.AttachmentsAttachmentAction
import ai.youkno.edgeserversdk.models.AttachmentsAttachmentBackground
import ai.youkno.edgeserversdk.models.AttachmentsAttachmentCover
import ai.youkno.edgeserversdk.models.AttachmentsAttachmentOverlay
import ai.youkno.edgeserversdk.models.AttachmentsAttachmentTextLine
import ai.youkno.edgeserversdk.models.AttachmentsAttachmentTranscodingInfo
...
data class AttachmentsAttachment (
    ...
    @Json(name = "action")
    val action: AttachmentsAttachmentAction? = null,

    @Json(name = "background")
    val background: AttachmentsAttachmentBackground? = null,

    @Json(name = "overlay")
    val overlay: AttachmentsAttachmentOverlay? = null,

    @Json(name = "headline1")
    val headline1: AttachmentsAttachmentTextLine? = null,

    @Json(name = "headline2")
    val headline2: AttachmentsAttachmentTextLine? = null,

    @Json(name = "mimeType")
    val mimeType: kotlin.String? = null,

    @Json(name = "coverList")
    val coverList: kotlin.collections.List<AttachmentsAttachmentCover>? = null,

    @Json(name = "transcodingInfo")
    val transcodingInfo: AttachmentsAttachmentTranscodingInfo? = null,
    ...
    val storageTypeAsEnum: AttachmentsAttachment.StorageTypeAsEnum? = null,

    @Json(name = "displayStyleAsEnum")
    val displayStyleAsEnum: AttachmentsAttachment.DisplayStyleAsEnum? = null,

    @Json(name = "visibilityAsEnum")
    val visibilityAsEnum: AttachmentsAttachment.VisibilityAsEnum? = null,
    ...
    val typeAsEnum: AttachmentsAttachment.TypeAsEnum? = null,
    ...
    val meaningAsEnum: AttachmentsAttachment.MeaningAsEnum? = null,

    @Json(name = "accessKeyEnforcementAsEnum")
    val accessKeyEnforcementAsEnum: AttachmentsAttachment.AccessKeyEnforcementAsEnum? = null,

    @Json(name = "accessKeyCtaModeAsEnum")
    val accessKeyCtaModeAsEnum: AttachmentsAttachment.AccessKeyCtaModeAsEnum? = null
