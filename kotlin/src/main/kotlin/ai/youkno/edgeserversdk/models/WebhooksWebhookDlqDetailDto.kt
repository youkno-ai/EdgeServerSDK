...
data class WebhooksWebhookDlqDetailDto (
    ...
    @Json(name = "status")
    val status: WebhooksWebhookDlqDetailDto.Status? = null,

    @Json(name = "deliveryOutcome")
    val deliveryOutcome: WebhooksWebhookDlqDetailDto.DeliveryOutcome? = null,
    ...
    val endpointCircuitState: WebhooksWebhookDlqDetailDto.EndpointCircuitState? = null,
