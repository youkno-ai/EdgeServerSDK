...
data class AiCategoryCategoryGeneratorInput (
    ...
    val bountyType: AiCategoryCategoryGeneratorInput.BountyType? = null,

    @Json(name = "zone")
    val zone: AiCategoryCategoryGeneratorInput.Zone? = null,

    @Json(name = "size")
    val propertySize: AiCategoryCategoryGeneratorInput.PropertySize? = null,

    @Json(name = "maxCategories")
    val maxCategories: kotlin.Int? = null,

    @Json(name = "style")
    val style: AiCategoryCategoryGeneratorInput.Style? = null,

    @Json(name = "palette")
    val palette: AiCategoryCategoryGeneratorInput.Palette? = null,
