...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelBaseSettingsReputationDef (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelBaseSettingsReputationDef>? = null
