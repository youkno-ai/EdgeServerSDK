...
data class CategoryGeneratorInput (
    ...
    val bountyType: CategoryGeneratorInput.BountyType? = null,

    @Json(name = "zone")
    val zone: CategoryGeneratorInput.Zone? = null,

    @Json(name = "size")
    val propertySize: CategoryGeneratorInput.PropertySize? = null,

    @Json(name = "maxCategories")
    val maxCategories: kotlin.Int? = null,

    @Json(name = "style")
    val style: CategoryGeneratorInput.Style? = null,

    @Json(name = "palette")
    val palette: CategoryGeneratorInput.Palette? = null,
