...
data class CoedgeappservermodelBountyAuctionInfoCurrentBid (

    @Json(name = "bid")
    val bid: CoedgeappservermodelReward? = null,
    ...
    val statusAsEnum: CoedgeappservermodelBountyAuctionInfoCurrentBid.StatusAsEnum? = null
