...
import ai.youkno.edgeserversdk.models.EdgeApiDataAppInfo
import ai.youkno.edgeserversdk.models.RestControllerUserControllerDeviceInfo
import ai.youkno.edgeserversdk.models.User
import ai.youkno.edgeserversdk.models.UserProfileExtrasWebsiteInfo
...
data class RestControllerUserControllerUserProfileExtraData (
    ...
    @Json(name = "kind")
    val kind: RestControllerUserControllerUserProfileExtraData.Kind? = null,

    @Json(name = "type")
    val type: RestControllerUserControllerUserProfileExtraData.Type? = null,

    @Json(name = "orgType")
    val orgType: RestControllerUserControllerUserProfileExtraData.OrgType? = null,

    @Json(name = "deviceInfo")
    val deviceInfo: RestControllerUserControllerDeviceInfo? = null,

    @Json(name = "appInfo")
    val appInfo: EdgeApiDataAppInfo? = null,

    @Json(name = "websites")
    val websites: kotlin.collections.List<UserProfileExtrasWebsiteInfo>? = null,
