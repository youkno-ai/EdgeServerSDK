...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelPosApiDataCycleCountResp (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelPosApiDataCycleCountResp>? = null
