...
data class CoedgeappserveraibountyDemoFeedGeneratorInput (
    ...
    @Json(name = "preferredTypes")
    val preferredTypes: kotlin.collections.List<CoedgeappserveraibountyDemoFeedGeneratorInput.PreferredTypes>? = null,
    ...
    enum class PreferredTypes(val value: kotlin.String) {
