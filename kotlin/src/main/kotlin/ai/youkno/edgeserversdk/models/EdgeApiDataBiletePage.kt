...
import ai.youkno.edgeserversdk.models.ThirdpartiesBileteRoTicket
...
data class EdgeApiDataBiletePage (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<ThirdpartiesBileteRoTicket>? = null,

    @Json(name = "email")
    val email: BaseSettingsAltEmail? = null
