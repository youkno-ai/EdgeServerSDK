...
data class CoedgeappserveraiproductProductGeneratorInput (
    ...
    val bountyType: CoedgeappserveraiproductProductGeneratorInput.BountyType? = null,

    @Json(name = "zone")
    val zone: CoedgeappserveraiproductProductGeneratorInput.Zone? = null,

    @Json(name = "size")
    val propertySize: CoedgeappserveraiproductProductGeneratorInput.PropertySize? = null,

    @Json(name = "maxProducts")
    val maxProducts: kotlin.Int? = null,

    @Json(name = "style")
    val style: CoedgeappserveraiproductProductGeneratorInput.Style? = null,

    @Json(name = "palette")
    val palette: CoedgeappserveraiproductProductGeneratorInput.Palette? = null,
