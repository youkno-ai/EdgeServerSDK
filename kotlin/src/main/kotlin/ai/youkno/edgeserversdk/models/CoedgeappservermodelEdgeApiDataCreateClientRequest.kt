...
data class CoedgeappservermodelEdgeApiDataCreateClientRequest (
    ...
    val clientInfo: CoedgeappservermodelClientInfo? = null,
    ...
    val taxAddress: CoedgeappservermodelMailingAddress? = null,
    ...
    @Json(name = "orgType")
    val orgType: CoedgeappservermodelEdgeApiDataCreateClientRequest.OrgType? = null,
    ...
    val businessType: CoedgeappservermodelEdgeApiDataCreateClientRequest.BusinessType? = null,

    @Json(name = "businessSubType")
    val businessSubType: CoedgeappservermodelEdgeApiDataCreateClientRequest.BusinessSubType? = null
