...
data class EdgeApiDataLocationGuessResult (

    @Json(name = "locationInfo")
    val locationInfo: PrivateCompanySettingsPointOfSaleInfoLocationInfo? = null,

    @Json(name = "deliveryMethod")
    val deliveryMethod: EdgeApiDataLocationGuessResult.DeliveryMethod? = null,

    @Json(name = "useType")
    val useType: EdgeApiDataLocationGuessResult.UseType? = null,
