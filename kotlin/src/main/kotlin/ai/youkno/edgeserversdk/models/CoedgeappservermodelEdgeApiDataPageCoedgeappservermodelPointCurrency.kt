...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelPointCurrency (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelPointCurrency>? = null
