...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelPaymentMethodInfo (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelPaymentMethodInfo>? = null
