...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelPosApiDataOrder (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelPosApiDataOrder>? = null
