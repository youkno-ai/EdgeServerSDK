...
import ai.youkno.edgeserversdk.models.EdgeApiDataSurveyResp
...
data class EdgeApiDataSurveyBundleResp (

    @Json(name = "bountyId")
    val bountyId: kotlin.String? = null,

    @Json(name = "bountyType")
    val bountyType: EdgeApiDataSurveyBundleResp.BountyType? = null,
    ...
    @Json(name = "surveys")
    val surveys: kotlin.collections.List<EdgeApiDataSurveyResp>? = null
