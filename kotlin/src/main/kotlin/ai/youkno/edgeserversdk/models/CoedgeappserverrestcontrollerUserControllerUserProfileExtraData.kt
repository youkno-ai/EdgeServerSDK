...
import ai.youkno.edgeserversdk.models.CoedgeappservermodelEdgeApiDataAppInfo
import ai.youkno.edgeserversdk.models.CoedgeappservermodelUser
import ai.youkno.edgeserversdk.models.CoedgeappserverrestcontrollerUserControllerDeviceInfo
import ai.youkno.edgeserversdk.models.CoedgeappserverservicemodelUserProfileExtrasWebsiteInfo
...
data class CoedgeappserverrestcontrollerUserControllerUserProfileExtraData (
    ...
    @Json(name = "kind")
    val kind: CoedgeappserverrestcontrollerUserControllerUserProfileExtraData.Kind? = null,

    @Json(name = "type")
    val type: CoedgeappserverrestcontrollerUserControllerUserProfileExtraData.Type? = null,

    @Json(name = "orgType")
    val orgType: CoedgeappserverrestcontrollerUserControllerUserProfileExtraData.OrgType? = null,

    @Json(name = "deviceInfo")
    val deviceInfo: CoedgeappserverrestcontrollerUserControllerDeviceInfo? = null,

    @Json(name = "appInfo")
    val appInfo: CoedgeappservermodelEdgeApiDataAppInfo? = null,

    @Json(name = "websites")
    val websites: kotlin.collections.List<CoedgeappserverservicemodelUserProfileExtrasWebsiteInfo>? = null,
