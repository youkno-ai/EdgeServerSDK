...
data class BountyColorScheme (
    ...
    val displayModeAsEnum: BountyColorScheme.DisplayModeAsEnum? = null,

    @Json(name = "patternTypeAsEnum")
    val patternTypeAsEnum: BountyColorScheme.PatternTypeAsEnum? = null
