...
import ai.youkno.edgeserversdk.models.SurveyResp
...
data class SurveyBundleResp (

    @Json(name = "bountyId")
    val bountyId: kotlin.String? = null,

    @Json(name = "bountyType")
    val bountyType: SurveyBundleResp.BountyType? = null,
    ...
    @Json(name = "surveys")
    val surveys: kotlin.collections.List<SurveyResp>? = null
