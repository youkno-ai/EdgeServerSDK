...
import ai.youkno.edgeserversdk.models.BaseSettingsText
...
data class BaseSettingsPolicy (
    ...
    @Json(name = "text")
    val text: BaseSettingsText? = null,

    @Json(name = "hint")
    val hint: kotlin.String? = null,

    @Json(name = "typeAsEnum")
    val typeAsEnum: BaseSettingsPolicy.TypeAsEnum? = null
