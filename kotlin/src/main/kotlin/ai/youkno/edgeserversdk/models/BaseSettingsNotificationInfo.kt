...
data class BaseSettingsNotificationInfo (
    ...
    val typeAsEnum: BaseSettingsNotificationInfo.TypeAsEnum? = null,

    @Json(name = "stateAsEnum")
    val stateAsEnum: BaseSettingsNotificationInfo.StateAsEnum? = null
