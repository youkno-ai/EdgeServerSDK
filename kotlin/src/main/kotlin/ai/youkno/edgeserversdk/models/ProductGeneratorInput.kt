...
data class ProductGeneratorInput (
    ...
    val bountyType: ProductGeneratorInput.BountyType? = null,

    @Json(name = "zone")
    val zone: ProductGeneratorInput.Zone? = null,

    @Json(name = "size")
    val propertySize: ProductGeneratorInput.PropertySize? = null,

    @Json(name = "maxProducts")
    val maxProducts: kotlin.Int? = null,

    @Json(name = "style")
    val style: ProductGeneratorInput.Style? = null,

    @Json(name = "palette")
    val palette: ProductGeneratorInput.Palette? = null,
