...
data class CoedgeappservermodelEdgeApiDataCompanyListResultCompanyData (
    ...
    @Json(name = "status")
    val status: CoedgeappservermodelEdgeApiDataCompanyListResultCompanyData.Status? = null
