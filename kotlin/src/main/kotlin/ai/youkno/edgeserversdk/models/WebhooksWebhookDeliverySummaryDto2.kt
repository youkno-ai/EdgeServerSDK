...
data class WebhooksWebhookDeliverySummaryDto2 (
    ...
    @Json(name = "status")
    val status: WebhooksWebhookDeliverySummaryDto2.Status? = null,

    @Json(name = "deliveryOutcome")
    val deliveryOutcome: WebhooksWebhookDeliverySummaryDto2.DeliveryOutcome? = null,
