...
import ai.youkno.edgeserversdk.models.CoedgeappservermodelSurvey
...
data class CoedgeappservermodelEdgeApiDataSurveyResp (

    @Json(name = "bountyId")
    val bountyId: kotlin.String? = null,

    @Json(name = "bountyType")
    val bountyType: CoedgeappservermodelEdgeApiDataSurveyResp.BountyType? = null,

    @Json(name = "survey")
    val survey: CoedgeappservermodelSurvey? = null,
