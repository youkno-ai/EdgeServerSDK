...
data class AttachmentsAttachmentAction (
    ...
    val bountyTypeAsEnum: AttachmentsAttachmentAction.BountyTypeAsEnum? = null,

    @Json(name = "actionTypeAsEnum")
    val actionTypeAsEnum: AttachmentsAttachmentAction.ActionTypeAsEnum? = null
