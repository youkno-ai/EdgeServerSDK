...
data class RestControllerOpenControllerInviteInfoResult (

    @Json(name = "inviteStatus")
    val inviteStatus: RestControllerOpenControllerInviteInfoResult.InviteStatus? = null,
    ...
    @Json(name = "logins")
    val logins: kotlin.collections.List<RestControllerOpenControllerInviteInfoResult.Logins>? = null,
