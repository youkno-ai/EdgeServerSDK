...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelAccessBountyContentResult (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelAccessBountyContentResult>? = null
