...
data class AiProductProductGeneratorInput (
    ...
    val bountyType: AiProductProductGeneratorInput.BountyType? = null,

    @Json(name = "zone")
    val zone: AiProductProductGeneratorInput.Zone? = null,

    @Json(name = "size")
    val propertySize: AiProductProductGeneratorInput.PropertySize? = null,

    @Json(name = "maxProducts")
    val maxProducts: kotlin.Int? = null,

    @Json(name = "style")
    val style: AiProductProductGeneratorInput.Style? = null,

    @Json(name = "palette")
    val palette: AiProductProductGeneratorInput.Palette? = null,
