...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelPosApiDataCustomer (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelPosApiDataCustomer>? = null
