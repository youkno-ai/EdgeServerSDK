...
import ai.youkno.edgeserversdk.models.FrontEndInfo
...
data class UserListResultUserData (
    ...
    @Json(name = "kind")
    val kind: UserListResultUserData.Kind? = null,

    @Json(name = "userSupportGroupMemberState")
    val userSupportGroupMemberState: UserListResultUserData.UserSupportGroupMemberState? = null,

    @Json(name = "latestFrontEndInfo")
    val latestFrontEndInfo: FrontEndInfo? = null,

    @Json(name = "segment")
    val segment: UserListResultUserData.Segment? = null
