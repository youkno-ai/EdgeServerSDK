...
import ai.youkno.edgeserversdk.models.CoedgeappservermodelEdgeApiDataSurveyResp
...
data class CoedgeappservermodelEdgeApiDataSurveyBundleResp (

    @Json(name = "bountyId")
    val bountyId: kotlin.String? = null,

    @Json(name = "bountyType")
    val bountyType: CoedgeappservermodelEdgeApiDataSurveyBundleResp.BountyType? = null,
    ...
    @Json(name = "surveys")
    val surveys: kotlin.collections.List<CoedgeappservermodelEdgeApiDataSurveyResp>? = null
