...
data class EdgeApiDataSearchCurrenciesFilter (
    ...
    @Json(name = "scope")
    val scope: EdgeApiDataSearchCurrenciesFilter.Scope? = null,

    @Json(name = "state")
    val state: EdgeApiDataSearchCurrenciesFilter.State? = null,
