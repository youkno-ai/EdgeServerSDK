...
data class CoedgeappservermodelEdgeApiDataPageCoedgeappservermodelUserNotificationConfig (
    ...
    @Json(name = "list")
    val list: kotlin.collections.List<CoedgeappservermodelUserNotificationConfig>? = null
