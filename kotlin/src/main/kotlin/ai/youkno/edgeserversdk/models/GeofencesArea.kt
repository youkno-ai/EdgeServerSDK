...
data class GeofencesArea (
    ...
    val areaTypeAsEnum: GeofencesArea.AreaTypeAsEnum? = null,

    @Json(name = "referenceArea")
    val referenceArea: kotlin.Boolean? = null,

    @Json(name = "radiusUnitAsEnum")
    val radiusUnitAsEnum: GeofencesArea.RadiusUnitAsEnum? = null,

    @Json(name = "referenceTypeAsEnum")
    val referenceTypeAsEnum: GeofencesArea.ReferenceTypeAsEnum? = null
