...
import ai.youkno.edgeserversdk.models.EdgeApiDataInventoryArea2
...
import ai.youkno.edgeserversdk.models.Zone
...
interface ClientControllerApi {
    ...
    */
     ...
     * @param xEdgeState  (optional)
     * @param xEdgeClientId  (optional)
     * @return [Call]<[EdgeApiDataInventoryArea2]>
     */
    @GET("api/v1/clients/{client}/inventoryAreas")
    fun getApiV1ClientsByClientInventoryareas(@Path("client") client: kotlin.String, @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<EdgeApiDataInventoryArea2>
     ...
     */
    @GET("api/v1/clients/{clientId}/zones")
    fun getApiV1ClientsByClientidZones(@Path("clientId") clientId: kotlin.String, @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<Zone>
    ...
    */
     ...
     * @param xEdgeState  (optional)
     * @param xEdgeClientId  (optional)
     * @return [Call]<[PointOfSaleInfoLocationInfo2]>
     */
    @POST("api/v1/clients/{clientId}/locations")
    fun postApiV1ClientsByClientidLocations(@Path("clientId") clientId: kotlin.String, @Body createUpdateLocationDto: CreateUpdateLocationDto, @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<PointOfSaleInfoLocationInfo2>
     ...
     */
    @PUT("api/v1/clients/locations/{clientId}")
    fun putApiV1ClientsLocationsByClientid(@Path("clientId") clientId: kotlin.String, @Body createUpdateLocationDto: CreateUpdateLocationDto, @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<PointOfSaleInfoLocationInfo2>
