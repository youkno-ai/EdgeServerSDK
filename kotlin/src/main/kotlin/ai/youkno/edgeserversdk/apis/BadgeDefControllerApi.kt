...
import ai.youkno.edgeserversdk.models.ModelBadgeDef
...
interface BadgeDefControllerApi {
     ...
     * @param xEdgeState  (optional)
     * @param xEdgeClientId  (optional)
     * @return [Call]<[ModelBadgeDef]>
     */
    @GET("api/v1/badges/defs")
    fun getApiV1BadgesDefs(@Query("badgeDefType") badgeDefType: kotlin.String? = "badge", @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<ModelBadgeDef>
