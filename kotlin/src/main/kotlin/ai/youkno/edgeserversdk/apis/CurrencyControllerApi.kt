...
import ai.youkno.edgeserversdk.models.EdgeApiDataPageEdgeApiDataCurrencyReportRecord
...
interface CurrencyControllerApi {
     ...
     * @return [Call]<[EdgeApiDataPageEdgeApiDataCurrencyReportRecord]>
     */
    @GET("api/v1/currencies/{code}/report")
    fun getApiV1CurrenciesByCodeReport(@Path("code") code: kotlin.String, @Query("order") order: kotlin.String? = null, @Query("start") start: kotlin.Int? = 0, @Query("limit") limit: kotlin.Int? = 20, @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<EdgeApiDataPageEdgeApiDataCurrencyReportRecord>
