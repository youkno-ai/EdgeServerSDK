...
interface AiControllerApi {
     ...
     */
    @POST("api/v1/ai/generate/stickers")
    fun postApiV1AiGenerateStickers(@Body input: Input, @Header("X-edge-agent") xEdgeAgent: kotlin.String? = null, @Header("X-edge-state") xEdgeState: kotlin.String? = null, @Header("X-edge-client-id") xEdgeClientId: kotlin.String? = null): Call<StartStickerGenerationResponse>
