...
import type { CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuth } from './CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuth';
import {
    CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuthFromJSON,
    CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuthFromJSONTyped,
    CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuthToJSON,
    CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuthToJSONTyped,
} from './CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuth';

/**
 * 
 * @export
 * @interface CoEdgeappServerModelBaseSettingsCustomRoleDef
 */
export interface CoEdgeappServerModelBaseSettingsCustomRoleDef {
    /**
     * 
     * @type {string}
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     */
    description?: string;
    /**
     * 
     * @type {{ [key: string]: CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuth; }}
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     */
    ops?: { [key: string]: CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuth; };
    /**
     * 
     * @type {Array<string>}
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     */
    declaredOps?: Array<CoEdgeappServerModelBaseSettingsCustomRoleDefDeclaredOpsEnum>;
    /**
     * 
     * @type {boolean}
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     ...
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     */
    forbiddenOps?: Array<CoEdgeappServerModelBaseSettingsCustomRoleDefForbiddenOpsEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     */
    allowedOps?: Array<CoEdgeappServerModelBaseSettingsCustomRoleDefAllowedOpsEnum>;
    /**
     * 
     * @type {boolean}
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     ...
     * @memberof CoEdgeappServerModelBaseSettingsCustomRoleDef
     */
    bountyTypes?: Array<CoEdgeappServerModelBaseSettingsCustomRoleDefBountyTypesEnum>;
}
 ...
 * @export
 */
export const CoEdgeappServerModelBaseSettingsCustomRoleDefDeclaredOpsEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
...
export type CoEdgeappServerModelBaseSettingsCustomRoleDefDeclaredOpsEnum = typeof CoEdgeappServerModelBaseSettingsCustomRoleDefDeclaredOpsEnum[keyof typeof CoEdgeappServerModelBaseSettingsCustomRoleDefDeclaredOpsEnum];

/**
 * @export
 */
export const CoEdgeappServerModelBaseSettingsCustomRoleDefForbiddenOpsEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
    CREATE_COMPANY: 'CREATE_COMPANY',
    CREATE_COMMENT: 'CREATE_COMMENT',
...
export type CoEdgeappServerModelBaseSettingsCustomRoleDefForbiddenOpsEnum = typeof CoEdgeappServerModelBaseSettingsCustomRoleDefForbiddenOpsEnum[keyof typeof CoEdgeappServerModelBaseSettingsCustomRoleDefForbiddenOpsEnum];

/**
 * @export
 */
export const CoEdgeappServerModelBaseSettingsCustomRoleDefAllowedOpsEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
    CREATE_COMPANY: 'CREATE_COMPANY',
    CREATE_COMMENT: 'CREATE_COMMENT',
...
export type CoEdgeappServerModelBaseSettingsCustomRoleDefAllowedOpsEnum = typeof CoEdgeappServerModelBaseSettingsCustomRoleDefAllowedOpsEnum[keyof typeof CoEdgeappServerModelBaseSettingsCustomRoleDefAllowedOpsEnum];

/**
 * @export
 */
export const CoEdgeappServerModelBaseSettingsCustomRoleDefOpsMapEnum = {
    ALWAYS: 'ALWAYS',
    NEVER: 'NEVER',
    MAY: 'MAY',
    SHOULD: 'SHOULD'
} as const;
export type CoEdgeappServerModelBaseSettingsCustomRoleDefOpsMapEnum = typeof CoEdgeappServerModelBaseSettingsCustomRoleDefOpsMapEnum[keyof typeof CoEdgeappServerModelBaseSettingsCustomRoleDefOpsMapEnum];

/**
 * @export
 */
export const CoEdgeappServerModelBaseSettingsCustomRoleDefBountyTypesEnum = {
    NONE: 'NONE',
    QUESTION: 'QUESTION',
    THREAD: 'THREAD',
...
export type CoEdgeappServerModelBaseSettingsCustomRoleDefBountyTypesEnum = typeof CoEdgeappServerModelBaseSettingsCustomRoleDefBountyTypesEnum[keyof typeof CoEdgeappServerModelBaseSettingsCustomRoleDefBountyTypesEnum];


/**
 * Check if a given object implements the CoEdgeappServerModelBaseSettingsCustomRoleDef interface.
 */
export function instanceOfCoEdgeappServerModelBaseSettingsCustomRoleDef(value: object): value is CoEdgeappServerModelBaseSettingsCustomRoleDef {
    return true;
}

export function CoEdgeappServerModelBaseSettingsCustomRoleDefFromJSON(json: any): CoEdgeappServerModelBaseSettingsCustomRoleDef {
    return CoEdgeappServerModelBaseSettingsCustomRoleDefFromJSONTyped(json, false);
}

export function CoEdgeappServerModelBaseSettingsCustomRoleDefFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoEdgeappServerModelBaseSettingsCustomRoleDef {
    if (json == null) {
        return json;
    }
    return {
        ...
        'ops': json['ops'] == null ? undefined : (mapValues(json['ops'], CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuthFromJSON)),
        'declaredOps': json['declaredOps'] == null ? undefined : json['declaredOps'],
...
export function CoEdgeappServerModelBaseSettingsCustomRoleDefToJSON(json: any): CoEdgeappServerModelBaseSettingsCustomRoleDef {
    return CoEdgeappServerModelBaseSettingsCustomRoleDefToJSONTyped(json, false);
}

export function CoEdgeappServerModelBaseSettingsCustomRoleDefToJSONTyped(value?: CoEdgeappServerModelBaseSettingsCustomRoleDef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'ops': value['ops'] == null ? undefined : (mapValues(value['ops'], CoEdgeappServerModelBaseSettingsCustomRoleDefRoleAuthToJSON)),
        'declaredOps': value['declaredOps'],
