...
import type { BaseSettingsCustomRoleDefRoleAuth } from './BaseSettingsCustomRoleDefRoleAuth';
import {
    BaseSettingsCustomRoleDefRoleAuthFromJSON,
    BaseSettingsCustomRoleDefRoleAuthFromJSONTyped,
    BaseSettingsCustomRoleDefRoleAuthToJSON,
    BaseSettingsCustomRoleDefRoleAuthToJSONTyped,
} from './BaseSettingsCustomRoleDefRoleAuth';

/**
 * 
 * @export
 * @interface BaseSettingsCustomRoleDef
 */
export interface BaseSettingsCustomRoleDef {
    /**
     * 
     * @type {string}
     * @memberof BaseSettingsCustomRoleDef
     */
    description?: string;
    /**
     * 
     * @type {{ [key: string]: BaseSettingsCustomRoleDefRoleAuth; }}
     * @memberof BaseSettingsCustomRoleDef
     */
    ops?: { [key: string]: BaseSettingsCustomRoleDefRoleAuth; };
    /**
     * 
     * @type {Array<string>}
     * @memberof BaseSettingsCustomRoleDef
     */
    declaredOps?: Array<BaseSettingsCustomRoleDefDeclaredOpsEnum>;
    /**
     * 
     * @type {boolean}
     * @memberof BaseSettingsCustomRoleDef
     ...
     * @memberof BaseSettingsCustomRoleDef
     */
    allowedOps?: Array<BaseSettingsCustomRoleDefAllowedOpsEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof BaseSettingsCustomRoleDef
     */
    forbiddenOps?: Array<BaseSettingsCustomRoleDefForbiddenOpsEnum>;
    /**
     * 
     * @type {boolean}
     * @memberof BaseSettingsCustomRoleDef
     ...
     * @memberof BaseSettingsCustomRoleDef
     */
    bountyTypes?: Array<BaseSettingsCustomRoleDefBountyTypesEnum>;
}
 ...
 * @export
 */
export const BaseSettingsCustomRoleDefDeclaredOpsEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
...
export type BaseSettingsCustomRoleDefDeclaredOpsEnum = typeof BaseSettingsCustomRoleDefDeclaredOpsEnum[keyof typeof BaseSettingsCustomRoleDefDeclaredOpsEnum];

/**
 * @export
 */
export const BaseSettingsCustomRoleDefAllowedOpsEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
    CREATE_COMPANY: 'CREATE_COMPANY',
    CREATE_COMMENT: 'CREATE_COMMENT',
...
export type BaseSettingsCustomRoleDefAllowedOpsEnum = typeof BaseSettingsCustomRoleDefAllowedOpsEnum[keyof typeof BaseSettingsCustomRoleDefAllowedOpsEnum];

/**
 * @export
 */
export const BaseSettingsCustomRoleDefForbiddenOpsEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
    CREATE_COMPANY: 'CREATE_COMPANY',
    CREATE_COMMENT: 'CREATE_COMMENT',
...
export type BaseSettingsCustomRoleDefForbiddenOpsEnum = typeof BaseSettingsCustomRoleDefForbiddenOpsEnum[keyof typeof BaseSettingsCustomRoleDefForbiddenOpsEnum];

/**
 * @export
 */
export const BaseSettingsCustomRoleDefOpsMapEnum = {
    ALWAYS: 'ALWAYS',
    NEVER: 'NEVER',
    MAY: 'MAY',
    SHOULD: 'SHOULD'
} as const;
export type BaseSettingsCustomRoleDefOpsMapEnum = typeof BaseSettingsCustomRoleDefOpsMapEnum[keyof typeof BaseSettingsCustomRoleDefOpsMapEnum];

/**
 * @export
 */
export const BaseSettingsCustomRoleDefBountyTypesEnum = {
    NONE: 'NONE',
    QUESTION: 'QUESTION',
    THREAD: 'THREAD',
...
export type BaseSettingsCustomRoleDefBountyTypesEnum = typeof BaseSettingsCustomRoleDefBountyTypesEnum[keyof typeof BaseSettingsCustomRoleDefBountyTypesEnum];


/**
 * Check if a given object implements the BaseSettingsCustomRoleDef interface.
 */
export function instanceOfBaseSettingsCustomRoleDef(value: object): value is BaseSettingsCustomRoleDef {
    return true;
}

export function BaseSettingsCustomRoleDefFromJSON(json: any): BaseSettingsCustomRoleDef {
    return BaseSettingsCustomRoleDefFromJSONTyped(json, false);
}

export function BaseSettingsCustomRoleDefFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseSettingsCustomRoleDef {
    if (json == null) {
        return json;
    }
    return {
        ...
        'ops': json['ops'] == null ? undefined : (mapValues(json['ops'], BaseSettingsCustomRoleDefRoleAuthFromJSON)),
...
export function BaseSettingsCustomRoleDefToJSON(json: any): BaseSettingsCustomRoleDef {
    return BaseSettingsCustomRoleDefToJSONTyped(json, false);
}

export function BaseSettingsCustomRoleDefToJSONTyped(value?: BaseSettingsCustomRoleDef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'ops': value['ops'] == null ? undefined : (mapValues(value['ops'], BaseSettingsCustomRoleDefRoleAuthToJSON)),
