 ...
 * 
 * @export
 * @interface ListsListDef2
 */
export interface ListsListDef2 {
    /**
     * 
     * @type {string}
     ...
     * @memberof ListsListDef2
     */
    visibilityTypeAsEnum?: ListsListDef2VisibilityTypeAsEnumEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    permissionTypeAsEnum?: ListsListDef2PermissionTypeAsEnumEnum;
    /**
     * 
     * @type {Array<string>}
     * @memberof ListsListDef2
     */
    bountyTypesAsEnum?: Array<ListsListDef2BountyTypesAsEnumEnum>;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    sortingModeAsEnum?: ListsListDef2SortingModeAsEnumEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    effectiveFilterModeAsEnum?: ListsListDef2EffectiveFilterModeAsEnumEnum;
    /**
     * 
     * @type {boolean}
     * @memberof ListsListDef2
     ...
     * @memberof ListsListDef2
     */
    effectiveMainBountyType?: ListsListDef2EffectiveMainBountyTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    filterBountyTypeAsEnum?: ListsListDef2FilterBountyTypeAsEnumEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    effectiveDisplayModeAsEnum?: ListsListDef2EffectiveDisplayModeAsEnumEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    notificationModeAsEnum?: ListsListDef2NotificationModeAsEnumEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    accessKeyEnforcementAsEnum?: ListsListDef2AccessKeyEnforcementAsEnumEnum;
    /**
     * 
     * @type {string}
     * @memberof ListsListDef2
     */
    accessKeyCtaModeAsEnum?: ListsListDef2AccessKeyCtaModeAsEnumEnum;
}
 ...
 * @export
 */
export const ListsListDef2EffectiveOpEnum = {
    NONE: 'NONE',
    SYSADMIN: 'SYSADMIN',
...
export type ListsListDef2EffectiveOpEnum = typeof ListsListDef2EffectiveOpEnum[keyof typeof ListsListDef2EffectiveOpEnum];
 ...
 * @export
 */
export const ListsListDef2VisibilityTypeAsEnumEnum = {
    DEFAULT: 'DEFAULT',
    USER: 'USER',
    VISIBLE: 'VISIBLE',
    UNKNOWN: 'UNKNOWN'
} as const;
export type ListsListDef2VisibilityTypeAsEnumEnum = typeof ListsListDef2VisibilityTypeAsEnumEnum[keyof typeof ListsListDef2VisibilityTypeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2PermissionTypeAsEnumEnum = {
    HIDE: 'HIDE',
    READ_ONLY: 'READ_ONLY',
...
export type ListsListDef2PermissionTypeAsEnumEnum = typeof ListsListDef2PermissionTypeAsEnumEnum[keyof typeof ListsListDef2PermissionTypeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2BountyTypesAsEnumEnum = {
    NONE: 'NONE',
    QUESTION: 'QUESTION',
    THREAD: 'THREAD',
...
export type ListsListDef2BountyTypesAsEnumEnum = typeof ListsListDef2BountyTypesAsEnumEnum[keyof typeof ListsListDef2BountyTypesAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2SortingModeAsEnumEnum = {
    NONE: 'NONE',
    DEFAULT: 'DEFAULT',
    POSTS: 'POSTS',
    MARKET: 'MARKET',
...
export type ListsListDef2SortingModeAsEnumEnum = typeof ListsListDef2SortingModeAsEnumEnum[keyof typeof ListsListDef2SortingModeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2EffectiveFilterModeAsEnumEnum = {
    NONE: 'NONE',
    DEFAULT: 'DEFAULT',
...
export type ListsListDef2EffectiveFilterModeAsEnumEnum = typeof ListsListDef2EffectiveFilterModeAsEnumEnum[keyof typeof ListsListDef2EffectiveFilterModeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2EffectiveMainBountyTypeEnum = {
    NONE: 'NONE',
    QUESTION: 'QUESTION',
    THREAD: 'THREAD',
    TALENT_SEARCH: 'TALENT_SEARCH',
...
export type ListsListDef2EffectiveMainBountyTypeEnum = typeof ListsListDef2EffectiveMainBountyTypeEnum[keyof typeof ListsListDef2EffectiveMainBountyTypeEnum];

/**
 * @export
 */
export const ListsListDef2FilterBountyTypeAsEnumEnum = {
    NONE: 'NONE',
    QUESTION: 'QUESTION',
    THREAD: 'THREAD',
    TALENT_SEARCH: 'TALENT_SEARCH',
...
export type ListsListDef2FilterBountyTypeAsEnumEnum = typeof ListsListDef2FilterBountyTypeAsEnumEnum[keyof typeof ListsListDef2FilterBountyTypeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2EffectiveDisplayModeAsEnumEnum = {
    NONE: 'NONE',
...
export type ListsListDef2EffectiveDisplayModeAsEnumEnum = typeof ListsListDef2EffectiveDisplayModeAsEnumEnum[keyof typeof ListsListDef2EffectiveDisplayModeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2NotificationModeAsEnumEnum = {
    MUTE: 'MUTE',
    DEFAULT: 'DEFAULT'
} as const;
export type ListsListDef2NotificationModeAsEnumEnum = typeof ListsListDef2NotificationModeAsEnumEnum[keyof typeof ListsListDef2NotificationModeAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2AccessKeyEnforcementAsEnumEnum = {
    HIDE: 'HIDE',
    BLUR: 'BLUR',
    UNKNOWN: 'UNKNOWN'
} as const;
export type ListsListDef2AccessKeyEnforcementAsEnumEnum = typeof ListsListDef2AccessKeyEnforcementAsEnumEnum[keyof typeof ListsListDef2AccessKeyEnforcementAsEnumEnum];

/**
 * @export
 */
export const ListsListDef2AccessKeyCtaModeAsEnumEnum = {
    DEFAULT: 'DEFAULT',
    NONE: 'NONE',
    UNKNOWN: 'UNKNOWN'
} as const;
export type ListsListDef2AccessKeyCtaModeAsEnumEnum = typeof ListsListDef2AccessKeyCtaModeAsEnumEnum[keyof typeof ListsListDef2AccessKeyCtaModeAsEnumEnum];


/**
 * Check if a given object implements the ListsListDef2 interface.
 */
export function instanceOfListsListDef2(value: object): value is ListsListDef2 {
    return true;
}

export function ListsListDef2FromJSON(json: any): ListsListDef2 {
    return ListsListDef2FromJSONTyped(json, false);
}

export function ListsListDef2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListsListDef2 {
    if (json == null) {
        return json;
    }
    return {
...
export function ListsListDef2ToJSON(json: any): ListsListDef2 {
    return ListsListDef2ToJSONTyped(json, false);
}

export function ListsListDef2ToJSONTyped(value?: ListsListDef2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
